...
#include "tensorflow-lite/flatbuffers/flatbuffers.h"  // from @flatbuffers
#include "tensorflow-lite/flatbuffers/flexbuffers.h"  // from @flatbuffers
#include "tensorflow-lite/flatbuffers/string.h"  // from @flatbuffers
...
#include "tensorflow-lite/tensorflow/compiler/mlir/lite/operator_converters.inc"
