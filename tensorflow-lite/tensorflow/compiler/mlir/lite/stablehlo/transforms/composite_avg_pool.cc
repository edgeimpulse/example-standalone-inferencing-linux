...
#include "tensorflow-lite/tensorflow/compiler/mlir/lite/stablehlo/transforms/composite_avg_pool.h"
...
#include "tensorflow-lite/tensorflow/compiler/mlir/lite/stablehlo/transforms/composite_utils.h"
