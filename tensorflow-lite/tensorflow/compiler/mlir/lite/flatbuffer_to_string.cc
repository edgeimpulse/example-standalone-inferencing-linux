...
#include "tensorflow-lite/flatbuffers/minireflect.h"  // from @flatbuffers
#include "tensorflow-lite/tensorflow/compiler/mlir/lite/schema/reflection/schema_generated.h"
