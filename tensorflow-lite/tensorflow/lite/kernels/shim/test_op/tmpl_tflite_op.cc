...
==============================================================================*/
#include "tensorflow-lite/tensorflow/lite/kernels/shim/test_op/tmpl_tflite_op.h"

#include <cstdint>

#include "tensorflow-lite/tensorflow/lite/c/common.h"
#include "tensorflow-lite/tensorflow/lite/kernels/shim/op_kernel.h"
#include "tensorflow-lite/tensorflow/lite/kernels/shim/test_op/tmpl_op.h"
#include "tensorflow-lite/tensorflow/lite/kernels/shim/tflite_op_shim.h"
#include "tensorflow-lite/tensorflow/lite/kernels/shim/tflite_op_wrapper.h"
