...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/4bit/sse_fully_connected.h"
#elif defined(FC_4BIT_NEON) && (defined(__ARM_NEON__) || defined(__ARM_NEON))
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/4bit/neon_fully_connected.h"
#else
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/4bit/fully_connected_reference.h"
#endif
