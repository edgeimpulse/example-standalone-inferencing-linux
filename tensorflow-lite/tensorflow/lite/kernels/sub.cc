...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/integer_ops/sub.h"
...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/reference/integer_ops/add.h"
