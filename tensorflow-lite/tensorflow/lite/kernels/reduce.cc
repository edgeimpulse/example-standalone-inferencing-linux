...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/integer_ops/mean.h"
...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/reduce.h"
