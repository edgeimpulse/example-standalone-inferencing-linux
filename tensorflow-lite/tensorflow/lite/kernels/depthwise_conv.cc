...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid.h"
...
#include "tensorflow-lite/tensorflow/lite/kernels/internal/reference/integer_ops/depthwise_conv.h"
