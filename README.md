...
Supported operations for the current version of are documented in the [EON Operator Matrix (TensorFlow)](https://docs.edgeimpulse.com/studio/projects/deployment/eon-compiler-operator-matrix-2-19)
...
1. Go to the **Deployment** page in the Edge Impulse Studio.
1. Select the 'DRP-AI TVM library', and the 'float32' optimizations.
